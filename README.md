...
Input netlists or circuits are represented as blocks connected and nets where each block is the first column and is connected to multiple nets. The cost function or the lower bound function is defined as: 
Cost = # crossing nets + # community mismatches
